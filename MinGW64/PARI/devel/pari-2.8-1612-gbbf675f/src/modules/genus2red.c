...
static const long VERYBIG = (1LL<<20);
static long
...
get_red(struct red *S, struct igusa_p *Ip, GEN polh, GEN p, long alpha, long r)
{
  ...
  switch(r)
  {
    case 0:
      ...
      S->t = stack_sprintf("I{%lld}", indice);
      S->pages = "159-177";
      S->g = cyclic(indice);
...
tame_2(struct igusa *I, struct igusa_p *Ip, long v12)
{
  ...
  {
    case 1: condp = 1;
      Ip->type = stack_sprintf("[I{%lld-0-0}] page 170", d);
      Ip->neron = cyclic(d); break;
    case 2:
      switch(r)
      {
        case 0: condp = 4;
          Ip->type = stack_sprintf("[I*{%lld-0-0}] page 171",d/2);
          Ip->neron = concat(dicyclic(2,2),groupH(d/2)); break;
        case 1:
          switch(q)
          {
            case 0: condp = 2;
              Ip->type = stack_sprintf("[II*{%lld-0}] page 172",d/2);
              Ip->neron = cyclic(1); break;
            case 1: condp = 3;
              Ip->type = stack_sprintf("[II{%lld-0}] page 171",d/2);
    ...
    case 3: condp = 3;
      ...
      {
        case 1:
          Ip->type = stack_sprintf("[IV-II{%lld}] page 175", (d-2)/3);
          break;
        case 2:
          Ip->type = stack_sprintf("[IV*-II{%lld}] page 175", (d-1)/3);
          break;
    ...
    case 4:
      switch(r)
      {
        case 1:
          ...
          {
            case 1: condp = 3;
              Ip->type = stack_sprintf("[III-II{%lld}] page 177",(d-2)/4);
              Ip->neron = cyclic(d/2); break;
            case 3: condp = 4;
              Ip->type = stack_sprintf("[III*-II*{%lld}] page 178",(d-2)/4);
    ...
    case 6:
      ...
      {
        case 2: condp = 4;
          Ip->type = stack_sprintf("[II*-II*{%lld}] page 176", (d-4)/6);
          Ip->neron = groupH((d+2)/6); break;
        case 4: condp = 4;
          Ip->type = stack_sprintf("[II-II*{%lld}] page 176", (d-2)/6);
...
tame_3(struct igusa *I, struct igusa_p *Ip, long v12)
{
  ...
  {
    case 1: condp = 2;
      Ip->type = stack_sprintf("[I{%lld-%lld-0}] page 179", d1,d2);
      Ip->neron = dicyclic(d1,d2); break;
    case 2:
      switch(r)
      {
        case 0: condp = 4;
          Ip->type = stack_sprintf("[I*{%lld-%lld-0}] page 180", d1/2,d2/2);
          Ip->neron = concat(groupH(d1/2),groupH(d2/2)); break;
        case 1:
          switch(flc)
          {
            case 1:condp = 3;
              Ip->type = stack_sprintf("[2I{%lld}-0] page 181", d1);
              Ip->neron = cyclic(d1); break;
            case 2: condp = 3;
              Ip->type = stack_sprintf("[II{%lld-%lld}] page 182",d1/2,d2/2);
              if ((d1*d2-4)&7)
      ...
      break;
    case 4: condp = 4;
      Ip->type = stack_sprintf("[III{%lld}] page 182", d1/2);
...
tame_4(struct igusa *I, struct igusa_p *Ip, long v12)
{
  ...
  {
    case 1: condp = 2;
      Ip->type = stack_sprintf("[I{%lld-%lld-%lld}] page 182",d1,d2,d3);
    ...
    case 2:
      switch(r)
      {
        ...
        case 1:
          ...
          {
            case 0: condp = 3;
              Ip->type = stack_sprintf("[II*{%lld-%lld}] page 184", f1/2,f2);
              Ip->neron = cyclic(f2); break;
            case 1: condp = 3;
              Ip->type = stack_sprintf("[II{%lld-%lld}] page 183", f1/2,f2);
      ...
      break;
    case 3: condp = 4;
      Ip->type = stack_sprintf("[III{%lld}] page 184",d1);
      Ip->neron = (d1%3)? cyclic(9): dicyclic(3,3); break;
    case 6: condp = 4;
      Ip->type = stack_sprintf("[III*{%lld}] page 184",d1/2);
      Ip->neron = cyclic(1); break;
...
tame_5(struct igusa *I, struct igusa_p *Ip, GEN dk)
{
  ...
  if (! odd(val[Ip->eps2]))
  {
    ...
    {
      case 1: condp = 0;
        Ip->type = stack_sprintf("[I{0}-I{0}-%lld] page 158", d);
        Ip->neron = cyclic(1); break;
      case 2:
        switch(dm)
        {
          case 0: condp = 4;
            Ip->type = stack_sprintf("[I*{0}-I*{0}-%lld] page 158",(d-2)/2);
            Ip->neron = mkvecsmall4(2,2,2,2); break;
          case 1: condp = 2;
            Ip->type = stack_sprintf("[I{0}-I*{0}-%lld] page 159",(d-1)/2);
            Ip->neron = dicyclic(2,2); break;
        }
        break;
      case 3:
        ...
        {
          case 0: condp = 4;
            Ip->type = stack_sprintf("[IV-IV*-%lld] page 165",(d-3)/3);
            Ip->neron = dicyclic(3,3); break;
          case 1:
            switch(r)
            {
              case 0: case 1: condp = 2;
                Ip->type = stack_sprintf("[I{0}-IV-%lld] page 160",(d-1)/3);
                Ip->neron = cyclic(3); break;
              case 2: condp = 4;
                Ip->type = stack_sprintf("[IV*-IV*-%lld] page 166",(d-4)/3);
                Ip->neron = dicyclic(3,3); break;
            }
            break;
          case 2:
            switch(r)
            {
              case 0: case 2: condp = 2;
                Ip->type = stack_sprintf("[I{0}-IV*-%lld] page 160",(d-2)/3);
                Ip->neron = cyclic(3); break;
              case 1: condp = 4;
                Ip->type = stack_sprintf("[IV-IV-%lld] page 165",(d-2)/3);
                Ip->neron = dicyclic(3,3); break;
            }
            break;
        }
      ...
      case 4:
        ...
        {
          case 0: condp = 4;
            Ip->type = stack_sprintf("[III-III*-%lld] page 169",(d-4)/4);
            Ip->neron = dicyclic(2,2); break;
          case 1:
            switch(r)
            {
              case 0: case 1: condp = 2;
                Ip->type = stack_sprintf("[I{0}-III-%lld] page 161",(d-1)/4);
                Ip->neron = cyclic(2); break;
              case 2: case 3: condp = 4;
                Ip->type = stack_sprintf("[I*{0}-III*-%lld] page 162",(d-5)/4);
          ...
          case 2: condp = 4;
            ...
            {
              case 1:
                Ip->type = stack_sprintf("[III-III-%lld] page 169",(d-2)/4);
                break;
              case 3:
                Ip->type = stack_sprintf("[III*-III*-%lld] page 169",(d-6)/4);
                break;
          ...
          case 3:
            switch(r)
            {
              case 0: case 3: condp = 2;
                Ip->type = stack_sprintf("[I{0}-III*-%lld] page 162",(d-3)/4);
                Ip->neron = cyclic(2); break;
      ...
      case 6:
        ...
        {
          case 0: condp = 4;
            Ip->type = stack_sprintf("[II-II*-%lld] page 163",(d-6)/6);
            Ip->neron = cyclic(1); break;
          case 1:
            switch(r)
            {
              case 0: case 1: condp = 2;
                Ip->type = stack_sprintf("[I{0}-II-%lld] page 159",(d-1)/6);
                Ip->neron = cyclic(1); break;
              case 2: case 5: condp = 4;
                Ip->type = stack_sprintf("[II*-IV-%lld] page 164",(d-7)/6);
                Ip->neron = cyclic(3); break;
              case 3: case 4: condp = 4;
                Ip->type = stack_sprintf("[I*{0}-IV*-%lld] page 161",(d-7)/6);
          ...
          case 2:
            ...
            {
              case 1: condp = 4;
                Ip->type = stack_sprintf("[II-II-%lld] page 163",(d-2)/6);
                Ip->neron = cyclic(1); break;
              case 3: case 5: condp = 4;
                Ip->type = stack_sprintf("[I*{0}-II*-%lld] page 160",(d-8)/6);
                Ip->neron = dicyclic(2,2); break;
          ...
          case 3:
            ...
            {
              case 1: case 2: condp = 4;
                Ip->type = stack_sprintf("[II-IV-%lld] page 164",(d-3)/6);
                break;
              case 4: case 5: condp = 4;
                Ip->type = stack_sprintf("[II*-IV*-%lld] page 164",(d-9)/6);
                break;
          ...
          case 4:
            switch(r)
            {
              case 1: case 3: condp = 4;
                Ip->type = stack_sprintf("[I*{0}-II-%lld] page 160",(d-4)/6);
                Ip->neron = dicyclic(2,2); break;
              case 5: condp = 4;
                Ip->type = stack_sprintf("[II*-II*-%lld] page 163",(d-10)/6);
                Ip->neron = cyclic(1); break;
          ...
          case 5:
            switch(r)
            {
              case 0: case 5: condp = 2;
                Ip->type = stack_sprintf("[I{0}-II*-%lld] page 160",(d-5)/6);
                Ip->neron = cyclic(1); break;
              case 1: case 4: condp = 4;
                Ip->type = stack_sprintf("[II-IV*-%lld] page 164",(d-5)/6);
                Ip->neron = cyclic(3); break;
              case 2: case 3: condp = 4;
                Ip->type = stack_sprintf("[I*{0}-IV-%lld] page 161",(d-5)/6);
                Ip->neron = mkvecsmall2(6,2); break;
            }
            break;
      ...
      case 12:
        ...
        switch(dm)
        {
          case 1:
            ...
            {
              case 3: case 10:
                Ip->type = stack_sprintf("[II*-III-%lld] page 166",(d-13)/12);
                Ip->neron = cyclic(2); break;
              case 4: case 9:
                Ip->type = stack_sprintf("[IV-III*-%lld] page 167",(d-13)/12);
          ...
          case 5:
            ...
            {
              case 2: case 3:
                Ip->type = stack_sprintf("[II-III-%lld] page 166",(d-5)/12);
                Ip->neron = cyclic(2); break;
              case 8: case 9:
                Ip->type = stack_sprintf("[IV*-III*-%lld] page 168",(d-17)/12);
                Ip->neron = cyclic(6); break;
          ...
          case 7:
            ...
            {
              case 3: case 4:
                Ip->type = stack_sprintf("[IV-III-%lld] page 167",(d-7)/12);
                Ip->neron = cyclic(6); break;
              case 9: case 10:
                Ip->type = stack_sprintf("[II*-III*-%lld] page 167",(d-19)/12);
                Ip->neron = cyclic(2); break;
          ...
          case 11:
            ...
            {
              case 3: case 8:
                Ip->type = stack_sprintf("[IV*-III-%lld] page 168",(d-11)/12);
                Ip->neron = cyclic(6); break;
              case 2: case 9:
                Ip->type = stack_sprintf("[II-III*-%lld] page 166",(d-11)/12);
                Ip->neron = cyclic(2); break;
  ...
  else
  {
    ...
    {
      case 2: condp = 2;
        Ip->type = stack_sprintf("[2I{0}-%lld] page 159",(d/2));
        Ip->neron = cyclic(1); break;
      case 4: condp = 4;
        Ip->type = stack_sprintf("[2I*{0}-%lld] page 159",(d/2-1)/2);
        Ip->neron = dicyclic(2,2); break;
      case 6: condp = 4;
        Ip->neron = cyclic(3);
        switch(r)
          {
          case 1:
            Ip->type = stack_sprintf("[2IV-%lld] page 165",(d/2-1)/3);
            break;
          case 2:
            Ip->type = stack_sprintf("[2IV*-%lld] page 165",(d/2-2)/3);
            break;
      ...
      case 8: condp = 4;
        ...
        {
          case 1:
            Ip->type = stack_sprintf("[2III-%lld] page 168",(d/2-1)/4);
            break;
          case 3:
            Ip->type = stack_sprintf("[2III*-%lld] page 168",(d/2-3)/4);
            break;
      ...
      case 12: condp = 4;
        ...
        {
          case 1:
            Ip->type = stack_sprintf("[2II-%lld] page 162",(d/2-1)/6);
            break;
          case 5:
            Ip->type = stack_sprintf("[2II*-%lld] page 163",(d/2-5)/6);
            break;
         ...
         GEN polh, GEN theta, long alpha, long dismin)
{
  ...
  {
    case 1: condp = 1;
      Ip->type = stack_sprintf("[I{%lld}-I{0}-%lld] page 170",d1,d);
      Ip->neron = cyclic(d1); break;
    case 2:
      switch(dm)
      {
        case 0: condp = 4;
          Ip->type=stack_sprintf("[I*{0}-I*{%lld}-%lld] page 171", d1/2,(d-2)/2);
    ...
    case 3: condp = 3;
      ...
      {
        case 1:
          Ip->type = stack_sprintf("[IV-I{%lld}-%lld] page 173",d1/3,(d-1)/3);
          break;
        case 2:
          Ip->type = stack_sprintf("[IV*-I{%lld}-%lld] page 173",d1/3,(d-2)/3);
          break;
        ...
        case 1:
          switch(r)
          {
            case 0: case 1: condp = 3;
              Ip->type=stack_sprintf("[III-I{%lld}-%lld] page 176",d1/4,(d-1)/4);
              Ip->neron = dicyclic(2,d1/4); break;
            case 2: case 3: condp = 4;
              Ip->type=stack_sprintf("[III*-I*{%lld}-%lld] page 177",d1/4,(d-5)/4);
        ...
        case 3:
          switch(r)
          {
            case 0: case 3: condp = 3;
              Ip->type=stack_sprintf("[III*-I{%lld}-%lld] page 176",d1/4,(d-3)/4);
              Ip->neron = dicyclic(2,d1/4); break;
            case 1: case 2: condp = 4;
              Ip->type=stack_sprintf("[III-I*{%lld}-%lld] page 177",d1/4,(d-3)/4);
              Ip->neron = concat(groupH(d1/4), cyclic(2)); break;
    ...
    case 6:
      switch(dm)
      {
        case 1:
          ...
          {
            case 0: case 1: condp = 3;
              Ip->type = stack_sprintf("[II-I{%lld}-%lld] page 172",d1/6,(d-1)/6);
              Ip->neron = cyclic(d1/6); break;
            case 3: case 4: condp = 4;
              Ip->type=stack_sprintf("[IV*-I*{%lld}-%lld] page 174",d1/6,(d-7)/6);
              Ip->neron = concat(groupH(d1/6), cyclic(3)); break;
            default: pari_err_BUG("tame6 [bug49]");
          }
          break;
        case 2: condp = 4;
          Ip->type = stack_sprintf("[II*-I*{%lld}-%lld] page 174",d1/6,(d-8)/6);
          Ip->neron = groupH(d1/6); break;
        case 4: condp = 4;
          Ip->type = stack_sprintf("[II-I*{%lld}-%lld] page 173",d1/6,(d-4)/6);
          Ip->neron = groupH(d1/6); break;
        case 5:
          switch(r)
          {
            case 0: case 5: condp = 3;
              Ip->type=stack_sprintf("[II*-I{%lld}-%lld] page 172",d1/6,(d-5)/6);
              Ip->neron = cyclic(d1/6); break;
            case 2: case 3: condp = 4;
              Ip->type=stack_sprintf("[IV-I*{%lld}-%lld] page 174",d1/6,(d-5)/6);
              Ip->neron = concat(groupH(d1/6), cyclic(3)); break;
         ...
         GEN polh, GEN theta, long alpha, long dismin)
{
  ...
  {
    case 1: condp = 2;
      Ip->type = stack_sprintf("[I{%lld}-I{%lld}-%lld] page 179",d1,d2,d);
      Ip->neron = dicyclic(d1,d2); break;
    case 2:
      if ( odd(val[Ip->eps2]) )
      {
        condp = 3;
        Ip->type = stack_sprintf("[2I{%lld}-%lld] page 181",d1,d/2);
        Ip->neron = cyclic(d1);
      }
      else if (dm == 0)
      {
        condp = 4;
        Ip->type = stack_sprintf("[I*{%lld}-I*{%lld}-%lld] page 180", d1/2,d2/2,(d-2)/2);
      ...
      else
      {
        ...
        Ip->type = stack_sprintf("[I{%lld}-I*{%lld}-%lld] page 180", d1/2,d1/2,(d-1)/2);
        Ip->neron = concat(H, H);
      }
      break;
    case 4: condp = 4;
      Ip->type = stack_sprintf("[2I*{%lld}-%lld] page 181",d1/2,(d-2)/4);
      Ip->neron = groupH(d1/2); break;
...
quartic(GEN polh, long alpha, long dismin, struct igusa_p *Ip)
{
  ...
  switch(r1)
  {
    case 0:
      ...
      {
        condp = 3;
        Ip->type = stack_sprintf("[2I{%lld}-%lld] page 181",d,R);
        Ip->neron = cyclic(d);
      }
      else
      {
        condp = 2;
        Ip->neron = cyclic(1);
        if (R) Ip->type = stack_sprintf("[2I{0}-%lld] page 159",R);
        else   Ip->type = "[II] page 155";
      }
      break;
    case 6: condp = 4;
      Ip->type = stack_sprintf("[2I*{%lld}-%lld] pages 159, 181",d,R);
      Ip->neron = dicyclic(2,2); break;
    case 3: condp = 4;
      Ip->type = stack_sprintf("[2III-%lld] page 168",R);
      Ip->neron = cyclic(2); break;
    case 9: condp = 4;
      Ip->type = stack_sprintf("[2III*-%lld] page 168",R);
      Ip->neron = cyclic(2); break;
    case 2: condp = dismin-12*R-13;
      Ip->type = stack_sprintf("[2II-%lld] page 162",R);
      Ip->neron = cyclic(1); break;
    case 8: condp = dismin-12*R-19;
      Ip->type = stack_sprintf("[2IV*-%lld] page 165",R);
      Ip->neron = cyclic(3); break;
    case 4: condp = dismin-12*R-15;
      Ip->type = stack_sprintf("[2IV-%lld] page 165",R);
      Ip->neron = cyclic(3); break;
    case 10: condp = dismin-12*R-21;
      Ip->type = stack_sprintf("[2II*-%lld] page 163",R);
      Ip->neron = cyclic(1); break;
         ...
         long dismin, struct igusa *I, struct igusa_p *Ip)
{
  ...
  { /* (r1,r2) = (0,0), (0,6), (6,0) or (6,6) */
    if (Ip->tt == 5)
    {
      ...
      case 0: /* (0,0) */
        condp = 0;
        Ip->type = stack_sprintf("[I{0}-I{0}-%lld] page 158",R);
        Ip->neron = cyclic(1); break;
      case 6: /* (0,6) or (6,0) */
        condp = 2;
        Ip->type = stack_sprintf("[I*{0}-I{0}-%lld] page 159",R);
        Ip->neron = dicyclic(2,2); break;
      case 12: /* (6,6) */
        condp = 4;
        Ip->type = stack_sprintf("[I*{0}-I*{0}-%lld] page 158",R);
    ...
    { /* (6,0) */
      ...
      if (Ip->tt == 6)
        Ip->type = stack_sprintf("[I*{%lld}-I{%lld}-%lld] page 170",indice,d-indice,R);
      else
        Ip->type = stack_sprintf("[I*{%lld}-I{%lld}-%lld] page 180",indice,d-indice,R);
    }
    else
    { /* (0,6) */
  ...
  if (Ip->tt == 7) pari_err_BUG("litredtp [switch ri]");
  {
    ...
    Ip->type = stack_sprintf("[%s-%s-%lld] pages %s", S1.t, S.t, R, S.pages);
  ...
  switch(lambda)
  {
        ...
        case 20: case 21:
          {
            ...
            else
            {
              ...
              {
                condp = dismin-mm-16;
                Ip->type = stack_sprintf("[III*{%lld}] page 184", mm);
                Ip->neron = cyclic(1);
              }
              else
              {
    ...
    case 1:
      switch(itos(gmulgs(theta, 60))+alpha)
      {
        ...
        case 20:
          ...
          condp = dismin-dism-3;
          Ip->type = stack_sprintf("[II-II*{%lld}] page 176", dism);
    ...
    case 2:
      ...
      switch(itos(gmulgs(theta,12))+alpha-4)
      {
        case 0:
          condp = dismin-dism-1;
          Ip->type = stack_sprintf("[IV-II{%lld}] page 175", dism);
        ...
        case 2: case 3:
          ...
          Ip->type = stack_sprintf("[II{%lld-%lld}] page 182", dism,indice);
          Ip->neron = both_odd(dism,indice)? dicyclic(2,2*dism): cyclic(4*dism);
          break;
        case 4:
          condp = dismin-dism-5;
          Ip->type = stack_sprintf("[IV*-II{%lld}] page 175",dism+1);
