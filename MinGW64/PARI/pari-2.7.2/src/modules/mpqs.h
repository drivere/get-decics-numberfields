...
#define MPQS_STRING_LENGTH         (4 * 1024ULL)
...
#define MPQS_FBE_DIVIDES_A   0x1ULL /* and Q(x) mod p only has degree 1 */
...
typedef struct mpqs_handle {
  ...
  pari_long *candidates;             /* collects promising sieve subscripts */
  char *relations;              /* freshly found relations (strings) */
  pari_long *relaprimes;             /* prime/exponent pairs in a relation */
  ...
  pari_long *histo_full;             /* distribution of full rels from sieve */
  pari_long *histo_lprl;             /* - of LP rels from sieve */
  pari_long *histo_drop;             /* - of useless candidates */
#endif
  ...
  pari_long lp_bound;                /* cutoff for Large Primes */
  pari_long digit_size_N;
  pari_long digit_size_kN;
...
{ /*       tol lp_scl     M   szFB  oA pmx1 1st  sti */
  {  /*9*/ 0.8F,   1,    900,    20,  3,   5, 70,  8},
  { /*10*/ 0.8F,   1,    900,    21,  3,   5, 70,  8},
  { /*11*/ 0.8F,   1,    920,    22,  3,   5, 70,  6},
  { /*12*/ 0.8F,   1,    960,    24,  3,   5, 70,  6},
  { /*13*/ 0.8F,   1,   1020,    26,  3,   5, 70,  6},
  { /*14*/ 0.8F,   1,   1100,    29,  3,   5, 70,  6},
  { /*15*/ 0.8F,   1,   1200,    32,  3,   5, 60,  8},
  { /*16*/ 0.8F,   1,   1500,    35,  3,   5, 60,  8},
  { /*17*/ 0.8F,   1,   1900,    40,  3,   5, 60,  8},
  { /*18*/ 0.8F,   1,   2500,    60,  3,   5, 50, 10},
  { /*19*/ 0.8F,   1,   3200,    80,  3,   5, 50, 10},
  { /*20*/ 0.8F,   1,   4000,   100,  3,   5, 40, 10},
  { /*21*/ 0.8F,   1,   4300,   100,  3,   5, 40, 10},
  { /*22*/ 0.8F,   1,   4500,   120,  3,   5, 40, 10},
  { /*23*/ 0.8F,   1,   4800,   140,  3,   5, 30, 10},
  { /*24*/ 0.8F,   1,   5100,   160,  4,   7, 30, 10},
  { /*25*/ 0.8F,   1,   5400,   180,  4,   7, 30, 10},
  { /*26*/ 0.9F,   1,   5700,   200,  4,   7, 30, 10},
  { /*27*/ 1.12F,  1,   6000,   220,  4,   7, 30, 10},
  { /*28*/ 1.17F,  1,   6300,   240,  4,  11, 30, 10},
  { /*29*/ 1.22F,  1,   6500,   260,  4,  11, 30, 10},
  { /*30*/ 1.30F,  1,   6800,   325,  4,  11, 20, 10},
  { /*31*/ 1.33F,  1,   7000,   355,  4,  13, 20, 10},
  { /*32*/ 1.36F,  1,   7200,   375,  5,  13, 20, 10},
  { /*33*/ 1.40F,  1,   7400,   400,  5,  13, 20, 10},
  { /*34*/ 1.43F,  1,   7600,   425,  5,  17, 20, 10},
  /* around here, sieving takes pari_long enough to make it worthwhile recording
   ...
   * 47 digits or so. */
  { /*35*/ 1.48F, 30,   7800,   550,  5,  17, 20, 10},
  { /*36*/ 1.53F, 45,   8100,   650,  5,  17, 20, 10},
  { /*37*/ 1.60F, 60,   9000,   750,  6,  19, 20, 10},
  { /*38*/ 1.66F, 70,  10000,   850,  6,  19, 20, 10},
  { /*39*/ 1.69F, 80,  11000,   950,  6,  23, 20, 10},
  /* around here, the largest prime in FB becomes comparable to M in size */
  { /*40*/ 1.69F, 80,  12500,  1000,  6,  23, 20, 10},
  { /*41*/ 1.69F, 80,  14000,  1150,  6,  23, 10, 10},
  { /*42*/ 1.69F, 80,  15000,  1300,  6,  29, 10, 10},
  { /*43*/ 1.69F, 80,  16000,  1500,  6,  29, 10, 10},
  { /*44*/ 1.69F, 80,  17000,  1700,  7,  31, 10, 10},
  { /*45*/ 1.69F, 80,  18000,  1900,  7,  31, 10, 10},
  { /*46*/ 1.69F, 80,  20000,  2100,  7,  37, 10, 10},
  { /*47*/ 1.69F, 80,  25000,  2300,  7,  37, 10, 10},
  { /*48*/ 1.69F, 80,  27500,  2500,  7,  37, 10, 10},
  { /*49*/ 1.72F, 80,  30000,  2700,  7,  41, 10, 10},
  { /*50*/ 1.75F, 80,  35000,  2900,  7,  41, 10, 10},
  { /*51*/ 1.80F, 80,  40000,  3000,  7,  43, 10, 10},
  { /*52*/ 1.85F, 80,  50000,  3200,  7,  43, 10, 10},
  { /*53*/ 1.90F, 80,  60000,  3500,  7,  47, 10, 10},
  { /*54*/ 1.95F, 80,  70000,  3800,  7,  47, 10, 10},
  { /*55*/ 1.95F, 80,  80000,  4100,  7,  53, 10, 10},
  { /*56*/ 1.95F, 80,  90000,  4400,  7,  53, 10,  8},
  { /*57*/ 2.00F, 80, 100000,  4700,  8,  53, 10,  8},
  { /*58*/ 2.05F, 80, 110000,  5000,  8,  59, 10,  8},
  { /*59*/ 2.10F, 80, 120000,  5400,  8,  59, 10,  8},
  { /*60*/ 2.15F, 80, 130000,  5800,  8,  61, 10,  8},
  { /*61*/ 2.20F, 80, 140000,  6100,  8,  61, 10,  8},
  { /*62*/ 2.25F, 80, 150000,  6400,  8,  67, 10,  6},
  { /*63*/ 2.39F, 80, 160000,  6700,  8,  67, 10,  6},
  { /*64*/ 2.30F, 80, 165000,  7000,  8,  67, 10,  6},
  { /*65*/ 2.31F, 80, 170000,  7300,  8,  71, 10,  6},
  { /*66*/ 2.32F, 80, 175000,  7600,  8,  71, 10,  6},
  { /*67*/ 2.33F, 80, 180000,  7900,  8,  73, 10,  6},
  { /*68*/ 2.34F, 80, 185000,  8200,  8,  73, 10,  6},
  { /*69*/ 2.35F, 80, 190000,  8600,  8,  79,  8,  6},
  { /*70*/ 2.36F, 80, 195000,  8800,  8,  79,  8,  6},
  { /*71*/ 2.37F, 80, 200000,  9000,  9,  79,  8,  6},
  { /*72*/ 2.38F, 80, 205000,  9250,  9,  83,  5,  5},
  { /*73*/ 2.41F, 80, 210000,  9500,  9,  83,  5,  5},
  { /*74*/ 2.46F, 80, 220000,  9750,  9,  83,  5,  5},
  { /*75*/ 2.51F, 80, 230000, 10000,  9,  89,  5,  5},
  { /*76*/ 2.56F, 80, 240000, 10500,  9,  89,  5,  5},
  { /*77*/ 2.58F, 80, 250000, 11200,  9,  89,  5,  5},
  { /*78*/ 2.60F, 80, 260000, 12500,  9,  89,  5,  5},
  { /*79*/ 2.63F, 80, 270000, 14000,  9,  97,  5,  4},
  { /*80*/ 2.65F, 80, 280000, 15500,  9,  97,  5,  4},
  { /*81*/ 2.72F, 80, 300000, 17000,  9,  97,  4,  4},
  { /*82*/ 2.77F, 80, 320000, 18500,  9, 101,  4,  4},
  { /*83*/ 2.82F, 80, 340000, 20000, 10, 101,  4,  4},
  { /*84*/ 2.84F, 80, 360000, 21500, 10, 103,  4,  4},
  { /*85*/ 2.86F, 80, 400000, 23000, 10, 103,  4,  3},
  { /*86*/ 2.88F, 80, 460000, 24500, 10, 107,  4,  3},
  ...
  { /*87*/ 2.90F, 80, 520000, 26000, 10, 107,  4,  3},
  { /*88*/ 2.91F, 80, 580000, 27500, 10, 109,  4,  3},
  { /*89*/ 2.92F, 80, 640000, 29000, 10, 109,  4,  3},
  { /*90*/ 2.93F, 80, 700000, 30500, 10, 113,  2,  2},
  { /*91*/ 2.94F, 80, 770000, 32200, 10, 113,  2,  2},
  /* entries below due to Thomas Denny, never tested */
  { /*92*/ 3.6F, 90, 2000000, 35000,  9, 113,  2,  2},
  { /*93*/ 3.7F, 90, 2000000, 37000,  9, 113,  2,  2},
  { /*94*/ 3.7F, 90, 2000000, 39500,  9, 127,  2,  2},
  { /*95*/ 3.7F, 90, 2500000, 41500,  9, 127,  2,  2},
  { /*96*/ 3.8F, 90, 2500000, 45000, 10, 127,  2,  2},
  { /*97*/ 3.8F, 90, 2500000, 47500, 10, 131,  2,  2},
  { /*98*/ 3.7F, 90, 3000000, 51000, 10, 131,  2,  2},
  { /*99*/ 3.8F, 90, 3000000, 53000, 10, 133,  2,  2},
  {/*100*/ 3.8F, 90, 3500000, 51000, 10, 133,  2,  2},
  {/*101*/ 3.8F, 90, 3500000, 54000, 10, 139,  2,  2},
  {/*102*/ 3.8F, 90, 3500000, 57000, 10, 139,  2,  2},
  {/*103*/ 3.9F, 90, 4000000, 61000, 10, 139,  2,  2},
  {/*104*/ 3.9F, 90, 4000000, 66000, 10, 149,  2,  2},
  {/*105*/ 3.9F, 90, 4000000, 70000, 10, 149,  2,  2},
  {/*106*/ 3.9F, 90, 4000000, 75000, 10, 151,  2,  2},
  {/*107*/ 3.9F, 90, 4000000, 80000, 10, 151,  2,  2},
};
