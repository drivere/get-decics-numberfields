...
{"algdep",0,(void*)algdep0,10,"GLD0,L,","algdep(z,k,{flag=0}): algebraic relations up to degree n of z, using lindep([1,z,...,z^(k-1)], flag)."},
...
{"ellglobalred",0,(void*)ellglobalred,5,"G","ellglobalred(E): E being an elliptic curve, returns [N,[u,r,s,t],c, faN,L], where N is the conductor of E, [u,r,s,t] leads to the standard model for E, c is the product of the local Tamagawa numbers c_p, faN is factor(N) and L[i] is elllocalred(E, faN[i,1]), where the local coordinate change has been deleted and replaced by a 0."},
...
{"elltwist",0,(void*)elltwist,5,"GDG","elltwist(E,P): returns the coefficients [a1,a2,a3,a4,a6] of the twist of the elliptic curve E by the quadratic extension defined by the polynomial P of degree 2."},
...
{"parforvec",0,(void*)parforvec0,13,"vV=GJDVDID0,L,","parforvec(X=v,expr1,{j},{expr2},{flag}): evaluates the sequence expr2 (dependent on X and j) for X as generated by forvec, in random order, computed in parallel. Substitute for j the value of expr1 (dependent on X)."},
...
{"polclass",0,(void*)polclass,9,"GD-1,L,Dn","polclass(D, {inv = 0}, {x = 'x}): return the Hilbert class polynomial for the disciminant D."},
...
{"polmodular",0,(void*)polmodular,9,"LD0,L,DGDnD0,L,","polmodular(L, {inv = 0}, {x = 'x}, {y = 'y}, {compute_derivs = 0}): return the modular polynomial of level L and invariant inv."},
...
{"tauramanujan",0,(void*)tauramanujan,4,"G","tau(n): compute the value of Ramanujan's tau function at n, assuming the GRH. Algorithm in O(n^{1/2+eps})."},
