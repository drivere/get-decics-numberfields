...
int main(int argc, char **argv)
  ...
  int ChkPntFlag = 0;
  int a5_Idx = 0;
  pari_long a22_Start = -1000000000;
  pari_long a21_Start = -1000000000;
  pari_long a32_Start = -1000000000;
  pari_long a31_Start = -1000000000;
...
//  for(;;) { }
...
#ifdef _WIN32
    fscanf(ChkpntFile, "%d %I64d %I64d %I64d %I64d %I64d %I64d %I64d %I64d %I64d", 
           &a5_Idx, &a22_Start, &a21_Start, &a32_Start, &a31_Start, &SV[0], &SV[1], &SV[2], &SV[3], &SV[4]);
#else
    fscanf(ChkpntFile, "%d %lld %lld %lld %lld %lld %lld %lld %lld %lld", 
           &a5_Idx, &a22_Start, &a21_Start, &a32_Start, &a31_Start, &SV[0], &SV[1], &SV[2], &SV[3], &SV[4]);
#endif
...
#ifdef _WIN32
  fprintf(stderr, "a22 Starting Value = %I64d.\n",a22_Start);
  fprintf(stderr, "a21 Starting Value = %I64d.\n",a21_Start);
  fprintf(stderr, "a32 Starting Value = %I64d.\n",a32_Start);
  fprintf(stderr, "a31 Starting Value = %I64d.\n",a31_Start);
...
#else
  fprintf(stderr, "a22 Starting Value = %lld.\n",a22_Start);
  fprintf(stderr, "a21 Starting Value = %lld.\n",a21_Start);
  fprintf(stderr, "a32 Starting Value = %lld.\n",a32_Start);
  fprintf(stderr, "a31 Starting Value = %lld.\n",a31_Start);
  ...
  fprintf(stderr,"Size of pari_long= %d.\n",sizeof(pari_long));
  fprintf(stderr,"Size of Long*    = %d.\n",sizeof(long*));
  fprintf(stderr,"Size of Long**   = %d.\n",sizeof(long**));
  fprintf(stderr,"Size of Long***  = %d.\n",sizeof(long***));
  fprintf(stderr,"Size of GEN      = %d.\n",sizeof(GEN));
  fprintf(stderr,"Size of pari_sp  = %d.\n",sizeof(pari_sp));
...
int do_checkpoint(int a5_Idx, pari_long a22_Start, pari_long a21_Start, pari_long a32_Start, pari_long a31_Start, pari_long Stat1, 
                  pari_long Stat2, pari_long Stat3, pari_long Stat4, pari_long Time)
  {
  int retval;
