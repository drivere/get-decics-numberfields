...
int MartinetSearch(char *FilenameIn, char *FilenameOut, int ChkPntFlag, int a5_Start_Idx,
                   long a22_Start, long a21_Start, long a32_Start, long a31_Start, long long *StatVec)
  {
  int  i,TgtFlag,Idx,NumVals_a5,a11,a12,r1,r2;
  long dK,a21_L,a21_U,a22_L,a22_U,a32_L,a32_U,ltop;
  long *a51,*a52;
  ...
  a51 = new long[NumVals_a5];
  if(!a51)  { cout << "Memory allocation error for a51\n"; exit(1); }
  a52 = new long[NumVals_a5];
  ...
  if(NumVals_a5==1)    // Then load the limits for a22
    ...
    long NumVals_a22 = a22_U - a22_L + 1;
    ...
    if(NumVals_a22==1)  // Then load the limits for a21
      ...
      long NumVals_a21 = a21_U - a21_L + 1;
      ...
      if(NumVals_a21==1)  // Then load the limits for a32
        ...
        if(infile.eof())  // Then this is an old style WU (a32_L,a32_U are not present)
          ...
          long NumVals_a32 = a32_U - a32_L + 1;
  ...
  long a21L_Orig = a21_L;
  long a22L_Orig = a22_L;
  long a32L_Orig = a32_L;
  ...
  long long PolyCount   = StatVec[0];
  long long Test1_Count = StatVec[1];
  long long Test2_Count = StatVec[2];
  long long Test3_Count = StatVec[3];
  long long Time_sec    = StatVec[4];
...
void Mart52Engine_Std(GEN K, long dK, int a11, int a12, long a51, long a52, long a22_L0, long a22_U0, 
                      long a21_L0, long a21_U0, long a32_L0, long a32_U0, float Delta_a5, float Delta_a22, 
                      float Delta_a21, float Delta_a32, int ChkPntFlag, int a5_Idx, long a31_Start,
                      long long *StatVec, ofstream& outfile)
  {
  long ltop,ltop1,ltop2,ltop3;
  long long PolyCount,Test1_Count,Test2_Count,Test3_Count,Time_sec;
  long a1sq_1,a1sq_2,a1cb_1,a1cb_2,a1_4th_1,a1_4th_2;
  ...
  long a51sq,a52sq,a51a52;
  long a21_L,a21_U,a22_L,a22_U,a31_L,a31_U,a32_L,a32_U,a41_L,a41_U,a42_L,a42_U;
  long b1,b2,b1b,b2b,b1c,b2c,s22,s32,s42;
  ...
  long NumVals_a5  = (long)floor(1.0/Delta_a5  + .5);
  ...
  a22_L = (long) ceil(.5*(b2-B_s2_sqrt/t22));
  a22_U = (long)floor(.5*(b2+B_s2_sqrt/t22));
  ...
  long NumVals_a22 = (long)floor(1.0/Delta_a22 + .5);
  long a22_L_Orig  = a22_U - NumVals_a22 + 1;
  ...
  for(a22=a22_L;a22<=a22_U;++a22)
    ...
    a21_L = (long) ceil(.5*(b1+(-B1+t12*s22)/t11));
    a21_U = (long)floor(.5*(b1+( B1+t12*s22)/t11));
    ...
    long NumVals_a21 = (long)floor(1.0/Delta_a21 + .5);
    long a21_L_Orig  = a21_U - NumVals_a21 + 1;
    ...
    for(a21=a21_L;a21<=a21_U;++a21)
      ...
      if( (s1a2_mag+s2a2_mag) <= 2.0*Ca1 )
        ...
        if(bb2>=bb2_L && bb2<=bb2_U)
          ...
          a32_L = (long) ceil( (b2b-a32_pre) / 3.0 );
          a32_U = (long)floor( (b2b+a32_pre) / 3.0 );
          ...
          long NumVals_a32 = (long)floor(1.0/Delta_a32 + .5);
          long a32_L_Orig  = a32_U - NumVals_a32 + 1;
          ...
          for(a32=a32_L;a32<=a32_U;++a32)
            ...
            a31_L = (long) ceil( (b1b+(-B1+t12*s32)/t11) / 3.0 );
            a31_U = (long)floor( (b1b+( B1+t12*s32)/t11) / 3.0 );

            long NumVals_a31 = a31_U-a31_L+1;
            if(NumVals_a31<1) NumVals_a31 = 1;
            long a31_L_Orig = a31_L;
            ...
            for(a31=a31_L;a31<=a31_U;++a31)
              ...
              if( (s1a3_mag<=2*tq[3]) && (s2a3_mag<=2*tqc[3]) )
                ...
                if(bb3>=bb3_L && bb3<=bb3_U)
                  ...
                  a42_L = (long) ceil( (b2c-a42_pre) / 4.0 );
                  a42_U = (long)floor( (b2c+a42_pre) / 4.0 );
                  ...
                  for(a42=a42_L;a42<=a42_U;++a42)
                    ...
                    a41_L = (long) ceil( (b1c+(-B1+t12*s42)/t11) / 4.0 );
                    a41_U = (long)floor( (b1c+( B1+t12*s42)/t11) / 4.0 );
...
void Mart52Engine_Tgt(GEN K, long dK, GEN dLg, int a11, int a12, long a51, long a52, long a22_L0,
                      long a22_U0, long a21_L0, long a21_U0, long a32_L0, long a32_U0, float Delta_a5, 
                      float Delta_a22, float Delta_a21, float Delta_a32, int ChkPntFlag, int a5_Idx, 
                      long a31_Start, long long *StatVec, ofstream& outfile)
  {
  long ltop,ltop1,ltop2,ltop3;
  long long PolyCount,Test1_Count,Test2_Count,Test3_Count,Time_sec;
  long a1sq_1,a1sq_2,a1cb_1,a1cb_2,a1_4th_1,a1_4th_2;
