...
\fun{ulong}{Fl_addmul_pre}{ulong x0, ulong y0, ulong x1, ulong p,  ulong pi}
returns $x0*y0+x1$ modulo $p$, assuming $pi$ is the pseudo inverse of $p$.

\fun{ulong}{Fl_addmulmul_pre}{ulong x0, ulong y0, ulong x1, ulong y1, ulong p,  ulong pi}
...
\fun{long}{FpX_nbfact_Frobenius}{GEN f, GEN XP, GEN p}, as \kbd{FpX\_nbfact},
where \kbd{XP = FpX\_Frobenius(f, p)}.
